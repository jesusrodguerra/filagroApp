...
public class BlankFragment extends Fragment {
    ...
    private void CalcularpHAgua(Double et1, Double et2, Double ph) {

        double resultado600 = ValoresPositivos(PH.LimitarDecimales(PH.CalcularpHAgua(et1, et2, ph, 600)));
        tv600.setText(PH.ImprimirResultado(resultado600, "600"));

        double resultado400 = ValoresPositivos(PH.LimitarDecimales(PH.CalcularpHAgua(et1, et2, ph, 400)));
        tv400.setText(PH.ImprimirResultado(resultado400, "400"));

        double resultado200 = ValoresPositivos(PH.LimitarDecimales(PH.CalcularpHAgua(et1, et2, ph, 200)));
        ...
        btn7.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (respuestaboton) {
                    ...
                    CalcularpHAgua(et1Valor, et2Valor, PH7);
        ...
        btn6.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(respuestaboton) {
                    ...
                    CalcularpHAgua(et1Valor, et2Valor, PH6);
        ...
        btn5_5.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(respuestaboton) {
                    ...
                    CalcularpHAgua(et1Valor, et2Valor, PH5_5);
        ...
        btn5.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(respuestaboton) {
                    ...
                    CalcularpHAgua(et1Valor, et2Valor, PH5);
        ...
        btn4.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(respuestaboton) {
                    ...
                    CalcularpHAgua(et1Valor, et2Valor, PH4);
